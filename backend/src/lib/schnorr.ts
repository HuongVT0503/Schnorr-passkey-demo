...
let msgBytes: Uint8Array;//normalise message to Uint8Array
    ...
    return secp.schnorr.verify(sigBytes, msgBytes, pubKeyForVerify);   ////secp.schnorr.verify(sigBytes, msgBytes, pubKeyByte) : all params are Uint8Arrays->match TS type
  } catch (err) {
